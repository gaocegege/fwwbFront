...
jQuery(document).ready(function() {
    $('#gritter-help').click(function() {
        $.gritter.add({
            title: '操作说明：',
            text: '<p style="font-family: 微软雅黑">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;每个方块代表一个车站，按行驶顺序排列，每一列为一条路线。' + '通过<b style="color: #f6ec59;">拖放</b>方块的方式进行路线的增删与修改。</p>' + '<p style="font-family: 微软雅黑">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;点击<b style="color: #f6ec59;">生成路线</b>，将根据所有站点生成最佳路线。生成结果<b style="color: #f6ec59;">不会</b>自动保存。</p>' + '<p style="font-family: 微软雅黑">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;点击<b style="color: #f6ec59;">重置地图</b>，将撤销所有更改，恢复上一次保存结果。</p>' + '<p style="font-family: 微软雅黑">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;离开页面前点击<b style="color: #f6ec59;">保存</b>按钮保存所有最新的站点及路线。第一列为未加入路线规划的站点，<b style="color: #f6ec59;">默认舍弃</b>。</p>',
            sticky: true //,
                //time: ''
        });
        return false;
